                        ...
                        <div class="col-md-12">
                            <div class="card mb-4 rounded-3 shadow-sw">
                                <div class="card-header py-3">
                                    <h4 class="my-0 fw-normal"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="black" class="bi bi-people" viewBox="0 0 16 16">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="cadcli.php" method="post">
            ...
            <br/>
            <button type="submit" class="btn btn-outline-sucess">CADASTRAR</button>
        </form>
      </div>
